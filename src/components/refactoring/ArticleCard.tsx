// This is a refactored copy of ArticleCard.tsx for Next.js. The original remains unmodified.
...
const ArticleCard = ({ post }: ArticleCardProps) => {
  ...
  return (
    <Link href={`/${post.slug}`} className="block h-full transition-all hover:scale-[1.01]">
